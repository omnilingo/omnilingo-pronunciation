...
jsd_file.close()
xen_file = open("sk_xen_sample.pickle", 'rb')
xen_scores = pickle.load(xen_file)
xen_file.close()
...
for lr, beta in hyperparams:
    ...
    for n, dataset in [('test_scores', test_scores), ('cos_scores', cos_scores), ('jsd_scores', jsd_scores), ('xen_scores', xen_scores)]:
